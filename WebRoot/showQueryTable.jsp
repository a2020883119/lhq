        	...
        	<table style="width:800px;  text-align:left">
            	<tr>
            		...
            		<td style="text-align:right">
            			<a href="showTable.action">SeeAll</a>&nbsp;&nbsp;
            		</td>
            	</tr>
            </table>   	
        </div>
				...
				<table border="1" cellspacing="0"
					...
					<c:forEach items="${sessionScope.stuQueryList}" var="list">
						<tr>
							...
							<td>${list.clas}</td>
							<td>${list.addr}</td>
							<td><a href="delete.action?id=${list.id}" onclick="return deleteCheck();" >删除</a>&nbsp; 
							    <a href="change.action?id=${list.id}&name=${list.name}&clas=${list.clas}&addr=${list.addr}">修改</a>
							</td>
						</tr>
					</c:forEach>
					<tr>
					...
					<tr>
						...
						<td colspan="3">
							<a href="queryPage.action?n=0&p=${sessionScope.page }">首页</a>&nbsp;-&nbsp;
							<a href="queryPage.action?n=1&p=${sessionScope.page }">上页</a>&nbsp;-&nbsp;
							${sessionScope.page }/${sessionScope.last }&nbsp;-&nbsp; 
							<a href="queryPage.action?n=2&p=${sessionScope.page }">下页</a>&nbsp;-&nbsp;
							<a href="queryPage.action?n=3&p=${sessionScope.last }">末页</a>&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
